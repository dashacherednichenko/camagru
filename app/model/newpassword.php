...
//    print_r($change_pass);
        ...
        return ("<div id='container'><div id='main_container'><p>Your password changed! Now you can enter the site with new password!</p><br> <a href='/camagru/login'>Login</a></div></div>");
    }
    else {
